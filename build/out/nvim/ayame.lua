...
function M.get()
    return {
        ...
        foreground      = "#cbbade", -- Foreground
        fg              = "#cbbade", -- Foreground
        fg200           = "#cbbade", -- Foreground
        ...
        teal100         = "#befcdb",
        cyan900         = "#225c63",
        cyan700         = "#43b9c6", -- Terminal Cyan, Classes, Identifiers, Variables
        darkcyan        = "#43b9c6", -- Terminal Cyan, Classes, Identifiers, Variables
        class           = "#43b9c6", -- Terminal Cyan, Classes, Identifiers, Variables
        identifier      = "#43b9c6", -- Terminal Cyan, Classes, Identifiers, Variables
        variable        = "#43b9c6", -- Terminal Cyan, Classes, Identifiers, Variables
        cyan300         = "#76ecf9",
        cyan100         = "#bbf5fc",
        blue900         = "#1b4162",
        ...
        toolbar         = "#221c35", -- Modal background
        bg600           = "#2b2343", -- Terminal Black, Subheader background, Line highlight, UI hover highlight
        black           = "#2b2343", -- Terminal Black, Subheader background, Line highlight, UI hover highlight
        subheader       = "#2b2343", -- Terminal Black, Subheader background, Line highlight, UI hover highlight
        tabline         = "#2b2343", -- Terminal Black, Subheader background, Line highlight, UI hover highlight
        hover           = "#2b2343", -- Terminal Black, Subheader background, Line highlight, UI hover highlight
        highlight       = "#2b2343", -- Terminal Black, Subheader background, Line highlight, UI hover highlight
        bg500           = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        gray            = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        gutter          = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        border          = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        rule            = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        button          = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        altrow          = "#342950", -- Terminal Bright Black, Buttons, Borders, Rules and guides, Line numbers, Alternate row background, Alternate modal background
        bg400           = "#3c305d",
        bg300           = "#45376a",
        bg200           = "#4d3e78",
        ...
        fg600           = "#63428a",
        fg500           = "#7c52ad",
        fg400           = "#9675bd", -- Cursor, Active line number, Subheader foreground, Badge background, Minimap and scrollbar background, Markdown table text
        cursor          = "#9675bd", -- Cursor, Active line number, Subheader foreground, Badge background, Minimap and scrollbar background, Markdown table text
        fg300           = "#b097ce",
